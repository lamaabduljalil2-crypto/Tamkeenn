...
track_progress($conn, 'story', 'story2', 'إطعام الحيوانات');
    ...
    <div class="stage">
      ...
      <div class="book" id="book">
        ...
        <div class="page cover-page" data-page="cover">
          <div class="page-face front">
            <div class="page-image-wrap">
              <img src="../../images/general/stories/images/cover2.png" alt="غلاف الكتاب" class="page-image">
            </div>
          </div>
        ...
        <div class="page p1" data-page="1">
          <div class="page-face front">
            <div class="page-image-wrap">
              <img src="../../images/general/stories/images/s2/page1.png" alt="الصفحة 1" class="page-image">
            </div>
          </div>
          <div class="page-face back">
        ...
        <div class="page p2" data-page="2">
          <div class="page-face front">
            <div class="page-image-wrap">
              <img src="../../images/general/stories/images/s2/page2.png" alt="الصفحة 2" class="page-image">
            </div>
          </div>
          <div class="page-face back">
            <div class="page-image-wrap" style="background:#fffdf8;"></div>
        ...
        <div class="page p3" data-page="3">
          <div class="page-face front">
            <div class="page-image-wrap">
              <img src="../../images/general/stories/images/s2/page3.png" alt="الصفحة 3" class="page-image">
            </div>
          </div>
          <div class="page-face back">
            <div class="page-image-wrap" style="background:#fffdf8;"></div>
        ...
        <div class="page p4" data-page="4">
          <div class="page-face front">
            <div class="page-image-wrap">
              <img src="../../images/general/stories/images/s2/page4.png" alt="الصفحة 4" class="page-image">
            </div>
          </div>
          <div class="page-face back">
            <div class="page-image-wrap" style="background:#fffdf8;"></div>
...
<script>
  ...
  */
  const pageData = {
    ...
    page1: {
      title: "رأى أحمد قطة صغيرة في الحديقة",
      video: "../../images/general/stories/videos/s2page1.mp4"
    },
    page2: {
      title: "وضع لها الحليب والطعام",
      video: "../../images/general/stories/videos/s2page2.mp4"
    },
    page3: {
      title: "لعب مع القطة قليلًا",
      video: "../../images/general/stories/videos/s2page3.mp4"
    },
    page4: {
      title: "نامت القطة بجانبه",
      video: "../../images/general/stories/videos/s2page4.mp4"
    }
  };
