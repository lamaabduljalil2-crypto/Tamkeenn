...
/* تسجيل تقدّم الطفل: زار قسم الخضار (الدالة مكتوبة جوّا الصفحة) */
...
track_progress($conn, 'section', 'section-vegetable', 'الخضار');
?>
<!DOCTYPE html>
...
.logo-box img{
  ...
  object-fit:contain;
    ...
    .veg-card{
      background:linear-gradient(180deg,#ffffffcc,#f8fff7cc);
      border-radius:26px;
    ...
    .veg-card.active{
      border-color:#8acb8f;
      box-shadow:0 14px 28px rgba(85, 140, 91, .18);
    }
    ...
    @media (max-width: 600px){
      ...
      .vegetables-grid{ grid-template-columns:1fr; }
      .veg-name{ font-size:20px; }
    ...
    @media (max-width: 768px) {
      ...
      /* page */
      .page-wrap { width:100% !important; max-width:100% !important; margin:8px auto 16px !important; padding:0 8px !important; }

      /* hero */
      .hero-box { padding:16px !important; border-radius:20px !important; }
      .hero-box h2 { font-size:22px !important; }
      .hero-box p { font-size:13px !important; }

      /* 3 بطاقات جنب بعض */
      .vegetables-grid { grid-template-columns:repeat(3, 1fr) !important; gap:8px !important; }
      .veg-card { padding:10px 6px 8px !important; border-radius:16px !important; }
      .veg-image-wrap { width:68px !important; height:68px !important; margin-bottom:8px !important; }
      .veg-image-wrap img { width:72% !important; height:72% !important; }
      .veg-name { font-size:13px !important; }

      /* تفاصيل */
      .selected-layout { grid-template-columns:1fr !important; }
      .selected-card-holder .veg-card { max-width:180px !important; position:static !important; }
      .details-card { grid-template-columns:1fr !important; padding:16px !important; }
      .details-title { font-size:24px !important; }
      .details-subtitle { font-size:16px !important; }
      .sign-video-box video { object-fit:contain !important; }
      .spelling-word img { width:48px !important; height:48px !important; }

      .cards-area { min-height:unset !important; }
    }
  </style>
</head>
<body>
  ...
  <main class="page-wrap">
    ...
    <section class="vegetables-section">
      ...
      <div class="cards-area">
        ...
        <div class="vegetables-grid" id="vegetablesGrid"></div>
  ...
  <script>
    ...
    const vegetables = <?php echo json_encode($itemsData, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES); ?>;
    ...
    function createCard(item) {
      ...
      card.innerHTML = `
        <div class="veg-image-wrap">
          <img src="${item.image}" alt="${item.name}">
        </div>
        <div class="veg-name">${item.name}</div>
      `;
    ...
    function showDetails(item) {
      vegetablesGrid.style.display = "none";
    ...
    function hideDetails() {
      ...
      vegetablesGrid.style.display = "grid";
      renderGrid();
