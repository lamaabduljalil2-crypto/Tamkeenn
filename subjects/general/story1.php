...
track_progress($conn, 'story', 'story1', 'رحلتي إلى المدرسة');
    ...
    <div class="stage">
      ...
      <div class="book" id="book">
        ...
        <div class="page cover-page" data-page="cover">
          <div class="page-face front">
            <div class="page-image-wrap">
              <img src="../../images/general/stories/images/cover1.png" alt="غلاف الكتاب" class="page-image">
            </div>
          </div>
        ...
        <div class="page p1" data-page="1">
          <div class="page-face front">
            <div class="page-image-wrap">
              <img src="../../images/general/stories/images/s1/page1.png" alt="الصفحة 1" class="page-image">
            </div>
          </div>
          <div class="page-face back">
        ...
        <div class="page p2" data-page="2">
          <div class="page-face front">
            <div class="page-image-wrap">
              <img src="../../images/general/stories/images/s1/page2.png" alt="الصفحة 2" class="page-image">
            </div>
          </div>
          <div class="page-face back">
            <div class="page-image-wrap" style="background:#fffdf8;"></div>
        ...
        <div class="page p3" data-page="3">
          <div class="page-face front">
            <div class="page-image-wrap">
              <img src="../../images/general/stories/images/s1/page3.png" alt="الصفحة 3" class="page-image">
            </div>
          </div>
          <div class="page-face back">
            <div class="page-image-wrap" style="background:#fffdf8;"></div>
        ...
        <div class="page p4" data-page="4">
          <div class="page-face front">
            <div class="page-image-wrap">
              <img src="../../images/general/stories/images/s1/page4.png" alt="الصفحة 4" class="page-image">
            </div>
          </div>
          <div class="page-face back">
            <div class="page-image-wrap" style="background:#fffdf8;"></div>
...
<script>
  ...
  */
  const pageData = {
    ...
    page1: {
      title: " ذهبت ليلى إلى المدرسة صباحاً 🎒",
      video: "../../images/general/stories/videos/s1page1.mp4"
    },
    page2: {
      title: "جلست في الصف وفتحت كتابها 📚",
      video: "../../images/general/stories/videos/s1page2.mp4"
    },
    page3: {
      title: "تعلمت حروفاً جديدة مع المعلمة ✏️",
      video: "../../images/general/stories/videos/s1page3.mp4"
    },
    page4: {
      title: "عادت إلى البيت وهي سعيدة 🏠",
      video: "../../images/general/stories/videos/s1page4.mp4"
    }
  };
