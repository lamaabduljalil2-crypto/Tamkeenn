...
.logo-box img{
  ...
  object-fit:contain;
    ...
    @media (max-width: 768px) {
      ...
      /* 3 فواكه جنب بعض */
      .fruits-grid { grid-template-columns:repeat(3, 1fr) !important; gap:8px !important; }
      .fruit-card { padding:10px 6px 8px !important; border-radius:16px !important; }
      .fruit-image-wrap { width:68px !important; height:68px !important; margin-bottom:8px !important; }
      .fruit-image-wrap img { width:72% !important; height:72% !important; }
      .fruit-name { font-size:13px !important; }

      .selected-layout { grid-template-columns:1fr !important; }
      .selected-card-holder .fruit-card { max-width:180px !important; position:static !important; }
