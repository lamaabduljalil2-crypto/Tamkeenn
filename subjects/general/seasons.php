...
if (isset($_SESSION['user_id']) && ($_SESSION['role'] ?? '') === 'child') {
    ...
    $__st = mysqli_prepare($conn, "INSERT INTO progress (user_id, child_name, activity_type, activity_key, activity_label) VALUES (?,?,'section','section-الفصول الأربعة','الفصول الأربعة') ON DUPLICATE KEY UPDATE activity_label=VALUES(activity_label), created_at=CURRENT_TIMESTAMP");
...
<head>
    ...
    <style>
        * {
        ...
        .display-area.active .season-image {
            opacity: 1;
            transform: scale(1);
        }
        ...
        .season-item.expanded:hover {
            transform: scale(1);
        }

        .season-item.expanded .icon-circle {
            width: 125px;
            height: 125px;
            margin-bottom: 10px;
        }

        .season-item.expanded .season-name {
            font-size: 30px;
        }
        ...
        .season-item.expanded .season-spelling {
            display: flex;
        }
        ...
        .display-area.active .season-text {
            opacity: 1;
        }

        .display-area:not(.active) .season-text {
            opacity: 0;
        }
    ...
    .children-dash-inner { display: grid !important; grid-template-columns: auto 1fr auto !important; padding: 8px 12px !important; gap: 8px !important; align-items: center !important; border-radius: 0 !important; }
    .dash-start, .dash-end { min-width: unset !important; }
    .logo-box img { width: 44px !important; height: 44px !important; }
    .logo-text { display: none !important; }
    .dash-nav { gap: 10px !important; flex-wrap: nowrap !important; justify-content: center !important; }
    ...
    .season-item.hidden { display: none !important; }

    /* عند تفعيل فصل: اخفِ كل شي أولاً */
    .season-image { display: none; }
    ...
    /* الشرح + فيديو الإشارة جنب بعض في صف واحد */
    .display-area.active .season-text {
        display: block !important; position: relative !important;
    ...
    /* اجعل main-view row عند تفعيل فصل */
    .display-area.active .main-view {
        flex-direction: row !important; flex-wrap: wrap !important;
        align-items: flex-start !important; justify-content: flex-start !important;
    }
    /* الصورة تأخذ صف كامل */
    .display-area.active .season-image { width: 100% !important; }

    /* seasons grid */
    .seasons-grid { grid-template-columns: repeat(2, 1fr) !important; }
    .season-item { min-height: 110px !important; padding: 10px 8px !important; }
    .season-item.expanded {
        position: relative !important; top: auto !important; right: auto !important;
        left: auto !important; bottom: auto !important;
        grid-column: 1 / -1 !important; transform: none !important;
    }
    .season-item.expanded:hover { transform: none !important; }
...
<div class="page">
    ...
    <div class="left-side">
        <div class="display-area" id="displayArea">
            <h2 class="main-title" id="displayTitle">هيا نتعرف على فصول السنة </h2>

            <div class="main-view">
                <img id="seasonImage" class="season-image" src="" alt="">
                ...
                <div class="main-sign-wrapper" id="mainSignWrapper">
                    <div class="video-player" onclick="toggleVideo('mainSignVideo','mainOverlay')">
                        <video id="mainSignVideo" class="main-sign-video" preload="metadata" playsinline webkit-playsinline>
                            <source src="../../images/general/seasons/videos/1.mp4" type="video/mp4">
                        </video>
                ...
                <div class="season-text" id="seasonText"></div>
    ...
    <div class="right-side">
        <h1 class="seasons-title">الفصول الأربعة</h1>

        <div class="seasons-grid">
            <div class="season-item spring" onclick="toggleSeason(this,'spring','فصل الربيع')">
                <div class="icon-circle">
                    <video autoplay muted loop playsinline>
                        <source src="../../images/general/seasons/icons/spring.mp4" type="video/mp4">
                    </video>
                </div>
                <div class="season-name">فصل الربيع</div>
                <div class="season-spelling"></div>
            </div>

            <div class="season-item summer" onclick="toggleSeason(this,'summer','فصل الصيف')">
                <div class="icon-circle">
                    <video autoplay muted loop playsinline>
                        <source src="../../images/general/seasons/icons/summer.mp4" type="video/mp4">
                    </video>
                </div>
                <div class="season-name">فصل الصيف</div>
                <div class="season-spelling"></div>
            </div>

            <div class="season-item autumn" onclick="toggleSeason(this,'autumn','فصل الخريف')">
                <div class="icon-circle">
                    <video autoplay muted loop playsinline>
                        <source src="../../images/general/seasons/icons/autumn.mp4" type="video/mp4">
                    </video>
                </div>
                <div class="season-name">فصل الخريف</div>
                <div class="season-spelling"></div>
            </div>

            <div class="season-item winter" onclick="toggleSeason(this,'winter','فصل الشتاء')">
                <div class="icon-circle">
                    <video autoplay muted loop playsinline>
                        <source src="../../images/general/seasons/icons/winter.mp4" type="video/mp4">
                    </video>
                </div>
                <div class="season-name">فصل الشتاء</div>
                <div class="season-spelling"></div>
            </div>
        </div>
    </div>
...
<script>
    ...
    const seasonTexts = {
        winter: "تتساقط الأمطار في فصل الشتاء فيصبح الجو بارداً وغالباً ما ينزل الثلج الأبيض",
        summer: "يكون الجو حاراً في فصل الصيف",
        spring: "تتفتح الأزهار في فصل الربيع ويصبح الجو جميلاً ومعتدلاً",
        autumn: "تتساقط الأوراق في فصل الخريف ويتغير لونها إلى الأصفر والبرتقالي"
    };
    ...
    function renderSpelling(element, title) {
        const spellingBox = element.querySelector(".season-spelling");
    ...
    function clearAllSpellings() {
        document.querySelectorAll(".season-spelling").forEach(box => {
            box.innerHTML = "";
        });
    }

    function changeSeason(season, title) {
        ...
        const signVideoPath = "../../images/general/seasons/videos/" + season + ".mp4";
        const imagePath = "../../images/general/seasons/images/" + season + ".PNG";

        displayTitle.textContent = title;
        document.getElementById("seasonText").textContent = seasonTexts[season];
        seasonImage.src = imagePath;
        seasonImage.alt = title;
    ...
    function resetMainView() {
        ...
        displayTitle.textContent = "هيا نتعرف على فصول السنة";
    ...
    function toggleSeason(element, season, title) {
        const allSeasons = document.querySelectorAll(".season-item");

        if (expandedSeason === element) {
        ...
        expandedSeason = element;
        changeSeason(season, title);
    }
