...
$base_dir = __DIR__ . '/../images/general/weather/';
$base_url = '../images/general/weather/';
$cfg_file = $base_dir . 'config.json';

$default_config = [
    'items' => [
        'sunny'  => ['name'=>'مشمس', 'text'=>'تشرق الشمس في الطقس المشمس ويكون الجو دافئاً ومضيئاً.'],
        'rainy'  => ['name'=>'ماطر',  'text'=>'يتساقط المطر في الطقس الماطر وتبتل الأرض والطرقات.'],
        'cloudy' => ['name'=>'غائم',  'text'=>'تغطي الغيوم السماء في الطقس الغائم وقد تحجب أشعة الشمس.'],
        'windy'  => ['name'=>'عاصف', 'text'=>'تهب الرياح في الطقس العاصف وتتحرك الأشجار بقوة.'],
        'snowy'  => ['name'=>'مثلج', 'text'=>'يتساقط الثلج ويكون الجو بارداً جداً.'],
    ]
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'upload_file') {
        ...
        if (isset($_FILES['file']) && $_FILES['file']['error'] === UPLOAD_ERR_OK) {
            ...
            if ($file_type === 'intro_video' && in_array($mime,$allowed_video)) { $dest=$base_dir.'videos/weather.mp4'; $valid=true; }
...
$colors = ['sunny'=>'#ed9154','rainy'=>'#9ac6e0','cloudy'=>'#7d98b4','windy'=>'#93d0c1','snowy'=>'#d6eaf8'];
?>
<!DOCTYPE html>
...
<h1 class="page-title">إدارة الطقس</h1>
<p class="page-sub">يمكنك تعديل النصوص والصور والفيديوهات لكل حالة طقس</p>
...
<div class="intro-card">
    ...
    <div class="upload-row">
        <form method="post" enctype="multipart/form-data" onsubmit="return false">
            ...
            <div class="preview-box" onclick="document.getElementById('introWeather').click()">
                <video autoplay muted loop playsinline>
                    <source src="<?= $base_url ?>videos/weather.mp4?t=<?= time() ?>" type="video/mp4">
                </video>
                <div class="overlay">🔄 تغيير</div>
            </div>
            <div class="upload-msg" id="msg-intro-weather" style="margin-top:6px"></div>
            <input type="file" name="file" id="introWeather" class="file-hidden" accept="video/mp4"
                   onchange="ajaxUpload(this.form, 'msg-intro-weather')">
        </form>
