...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($number_id < 0) {
        ...
        if ($error === '') {
            ...
            mysqli_stmt_bind_param($checkStmt, "ssi", $subject, $type, $number_id);
            mysqli_stmt_execute($checkStmt);
            $checkResult = mysqli_stmt_get_result($checkStmt);
            $oldRow = mysqli_fetch_assoc($checkResult);
...
<title>إضافة رقم عربي جديد</title>
...
<h1 class="page-title">إضافة رقم عربي جديد</h1>
...
<img src="../<?php echo htmlspecialchars($item['sign_image'] ?: defaultSignPath($item['number_id'])); ?>"
class="preview-img"
id="signPreview"
...
<img src="../<?php echo htmlspecialchars($item['number_image'] ?: defaultNumberImagePath($item['number_id'])); ?>"
class="preview-img"
id="numberPreview"
...
<img src="../<?php echo htmlspecialchars($item['coloring_image'] ?: defaultColoringPath($item['number_id'])); ?>"
class="preview-img"
id="coloringPreview"
